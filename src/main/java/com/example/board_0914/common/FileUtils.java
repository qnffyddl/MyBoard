package com.example.board_0914.common;
        ...
        while(iterator.hasNext()) {
            ...
            for(MultipartFile multipartFile : list) {
                if(multipartFile.isEmpty() == false) {
                    ...
                    boardFile.setBoardNoFk(boardIdx);
                    //boardFile.setFileSize((int) multipartFile.getSize());
                    boardFile.setFileMount((int) multipartFile.getSize());
